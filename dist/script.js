...
class Game {
    constructor() {
        ...
        this.holes.forEach((hole) => hole.addEventListener("click", this.whack.bind(this, hole)));
    }
    startGame() {
        //init
        this.score = 0;
        ...
        this.countdownTimerId = setInterval(this.countDown.bind(this), gameConfig.countdownSpeed);
    }
    showRandomMole() {
